...
export default function Projects() {
  ...
  return (
    <section id="proyectos" className="py-20 px-4 bg-surface">
      <div
        ref={ref}
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project) => (
            <div
              key={project.title}
              className="bg-bg border border-white/10 rounded-xl p-6 flex flex-col glow-hover gradient-border transition-all duration-300"
            >
